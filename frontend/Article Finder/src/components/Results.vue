      ...
      <table class="table" id="resultsTable">
        ...
        <tbody>
          ...
          <tr v-for="(article,i) in dataFromServer" :key="i">
            ...
            <td><a class="nav-link" v-bind:href="''+dataFromServer[i].article.path+''" target="_blank"><button class="btn-dark"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="16" fill="currentColor" class="bi bi-file-earmark-pdf-fill" viewBox="0 0 16 16">
...
</svg> VIEW FULL VERSION</button></a></td>
            <!---->
          </tr>
        </tbody>
      </table>
