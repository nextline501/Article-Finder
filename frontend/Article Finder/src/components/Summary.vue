...
<div class="container" id="summaryContainer">
  <div class="col">
    ...
    <!-- <div class="col">
     ...
     <div class="row-1"><a :href="currentArticle.path" target="_blank"><button class="btn-dark"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="16" fill="currentColor" class="bi bi-file-earmark-pdf-fill" viewBox="0 0 16 16">
...
</svg> VIEW FULL VERSION</button></a></div>
  </div>
</template>

<script>
  import ReadingTips from "./ReadingTips.vue"
